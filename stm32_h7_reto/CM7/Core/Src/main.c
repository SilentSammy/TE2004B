...
bool readOrientation(Orientation* orientation)
{
    ...
    // Get the orientation message from latestMsgs array
...
bool readAngularVelocity(AngularVelocity* angvel)
{
    ...
    // Get the angular velocity message from latestMsgs array
...
bool readLinearAcceleration(LinearAcceleration* accel)
{
    ...
    // Get the linear acceleration message from latestMsgs array
